...
#if defined(_WIN32) && !defined(__SYMBIAN32__) && !defined(_XBOX)	//FYMP: added XBox exclusion
#include <windows.h>
#ifndef XP_WIN
#define XP_WIN 1
#endif
...
FYMP_PRXSYM_WEBKIT void*       NP_LOADDS NPN_MemAlloc(uint32_t size); // FYWEBKITMOD exported symbol
FYMP_PRXSYM_WEBKIT void        NP_LOADDS NPN_MemFree(void* ptr); // FYWEBKITMOD exported symbol
