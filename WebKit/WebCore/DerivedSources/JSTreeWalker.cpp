...
{
    putDirect(exec->propertyNames().prototype, JSTreeWalkerPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSTreeWalkerPrototype(globalObject, JSTreeWalkerPrototype::createStructure(globalObject->objectPrototype()));
}
