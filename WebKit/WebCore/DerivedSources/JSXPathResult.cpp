...
{
    putDirect(exec->propertyNames().prototype, JSXPathResultPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSXPathResultPrototype(globalObject, JSXPathResultPrototype::createStructure(globalObject->objectPrototype()));
}
