...
static const HashTableValue JSHTMLSelectElementTableValues[17] =
{
...
static JSC_CONST_HASHTABLE HashTable JSHTMLSelectElementTable = { 35, 31, JSHTMLSelectElementTableValues, 0 };
...
{
    putDirect(exec->propertyNames().prototype, JSHTMLSelectElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLSelectElementPrototype(globalObject, JSHTMLSelectElementPrototype::createStructure(JSHTMLElementPrototype::self(exec, globalObject)));
}
