...
static const HashTableValue JSAttrTableValues[8] =
{
    ...
    { "style", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsAttrStyle), (intptr_t)0 THUNK_GENERATOR(0) },
...
{
    putDirect(exec->propertyNames().prototype, JSAttrPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSAttrPrototype(globalObject, JSAttrPrototype::createStructure(JSNodePrototype::self(exec, globalObject)));
}
