...
{
    putDirect(exec->propertyNames().prototype, JSNodeListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSNodeListPrototype(globalObject, JSNodeListPrototype::createStructure(globalObject->objectPrototype()));
}
