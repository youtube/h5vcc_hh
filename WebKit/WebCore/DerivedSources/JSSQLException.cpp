...
const ClassInfo JSSQLExceptionConstructor::s_info = { "SQLExceptionConstructor", 0, &JSSQLExceptionConstructorTable, 0 };

JSSQLExceptionConstructor::JSSQLExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSQLExceptionConstructor::createStructure(globalObject->objectPrototype()), globalObject)
{
    putDirect(exec->propertyNames().prototype, JSSQLExceptionPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
const ClassInfo JSSQLExceptionPrototype::s_info = { "SQLExceptionPrototype", 0, 0, getJSSQLExceptionPrototypeTable };
...
const ClassInfo JSSQLException::s_info = { "SQLException", 0, 0, getJSSQLExceptionTable };
...
{
    return new (exec) JSSQLExceptionPrototype(globalObject, JSSQLExceptionPrototype::createStructure(globalObject->objectPrototype()));
}
