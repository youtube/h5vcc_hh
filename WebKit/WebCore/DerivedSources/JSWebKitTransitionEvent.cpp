...
{
    putDirect(exec->propertyNames().prototype, JSWebKitTransitionEventPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSWebKitTransitionEventPrototype(globalObject, JSWebKitTransitionEventPrototype::createStructure(JSEventPrototype::self(exec, globalObject)));
}
