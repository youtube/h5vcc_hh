...
{
    putDirect(exec->propertyNames().prototype, JSAbstractWorkerPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSAbstractWorkerPrototype(globalObject, JSAbstractWorkerPrototype::createStructure(globalObject->objectPrototype()));
}
