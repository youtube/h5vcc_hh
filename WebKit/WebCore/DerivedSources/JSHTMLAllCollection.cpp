...
{
    putDirect(exec->propertyNames().prototype, JSHTMLAllCollectionPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLAllCollectionPrototype(globalObject, JSHTMLAllCollectionPrototype::createStructure(globalObject->objectPrototype()));
}
