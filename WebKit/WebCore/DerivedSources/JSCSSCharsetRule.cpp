...
{
    putDirect(exec->propertyNames().prototype, JSCSSCharsetRulePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSCSSCharsetRulePrototype(globalObject, JSCSSCharsetRulePrototype::createStructure(JSCSSRulePrototype::self(exec, globalObject)));
}
