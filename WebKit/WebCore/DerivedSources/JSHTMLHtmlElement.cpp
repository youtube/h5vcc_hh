...
static JSC_CONST_HASHTABLE HashTable JSHTMLHtmlElementTable = { 4, 3, JSHTMLHtmlElementTableValues, 0 };
...
{
    putDirect(exec->propertyNames().prototype, JSHTMLHtmlElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLHtmlElementPrototype(globalObject, JSHTMLHtmlElementPrototype::createStructure(JSHTMLElementPrototype::self(exec, globalObject)));
}
