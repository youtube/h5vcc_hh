...
const ClassInfo JSTimeRangesConstructor::s_info = { "TimeRangesConstructor", 0, &JSTimeRangesConstructorTable, 0 };

JSTimeRangesConstructor::JSTimeRangesConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTimeRangesConstructor::createStructure(globalObject->objectPrototype()), globalObject)
{
    putDirect(exec->propertyNames().prototype, JSTimeRangesPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSTimeRangesPrototype(globalObject, JSTimeRangesPrototype::createStructure(globalObject->objectPrototype()));
}
