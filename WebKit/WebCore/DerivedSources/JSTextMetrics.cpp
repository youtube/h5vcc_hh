...
{
    putDirect(exec->propertyNames().prototype, JSTextMetricsPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSTextMetricsPrototype(globalObject, JSTextMetricsPrototype::createStructure(globalObject->objectPrototype()));
}
