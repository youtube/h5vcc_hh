...
const ClassInfo JSSQLTransactionSyncPrototype::s_info = { "SQLTransactionSyncPrototype", 0, 0, getJSSQLTransactionSyncPrototypeTable };
...
const ClassInfo JSSQLTransactionSync::s_info = { "SQLTransactionSync", 0, 0, 0 };
...
{
    return new (exec) JSSQLTransactionSyncPrototype(globalObject, JSSQLTransactionSyncPrototype::createStructure(globalObject->objectPrototype()));
}
