...
{
    putDirect(exec->propertyNames().prototype, JSXMLHttpRequestUploadPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSXMLHttpRequestUploadPrototype(globalObject, JSXMLHttpRequestUploadPrototype::createStructure(globalObject->objectPrototype()));
}
