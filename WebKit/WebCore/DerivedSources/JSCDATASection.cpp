...
{
    putDirect(exec->propertyNames().prototype, JSCDATASectionPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSCDATASectionPrototype(globalObject, JSCDATASectionPrototype::createStructure(JSTextPrototype::self(exec, globalObject)));
}
