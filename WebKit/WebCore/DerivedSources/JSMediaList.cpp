...
{
    putDirect(exec->propertyNames().prototype, JSMediaListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSMediaListPrototype(globalObject, JSMediaListPrototype::createStructure(globalObject->objectPrototype()));
}
