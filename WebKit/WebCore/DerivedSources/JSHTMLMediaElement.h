...
JSC::EncodedJSValue JSC_HOST_CALL jsHTMLMediaElementPrototypeFunctionAddTextTrack(JSC::ExecState*); // FYMP - not auto-generated!

// Attributes

JSC::JSValue jsHTMLMediaElementTextTracks(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&); // FYMP - not auto-generated!
