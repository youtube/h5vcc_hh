...
{
    putDirect(exec->propertyNames().prototype, JSNamedNodeMapPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSNamedNodeMapPrototype(globalObject, JSNamedNodeMapPrototype::createStructure(globalObject->objectPrototype()));
}
