...
{
    putDirect(exec->propertyNames().prototype, JSEntityReferencePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSEntityReferencePrototype(globalObject, JSEntityReferencePrototype::createStructure(JSNodePrototype::self(exec, globalObject)));
}
