...
{
    putDirect(exec->propertyNames().prototype, JSCSSStyleRulePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSCSSStyleRulePrototype(globalObject, JSCSSStyleRulePrototype::createStructure(JSCSSRulePrototype::self(exec, globalObject)));
}
