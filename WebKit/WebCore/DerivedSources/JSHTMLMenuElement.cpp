...
{
    putDirect(exec->propertyNames().prototype, JSHTMLMenuElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLMenuElementPrototype(globalObject, JSHTMLMenuElementPrototype::createStructure(JSHTMLElementPrototype::self(exec, globalObject)));
}
