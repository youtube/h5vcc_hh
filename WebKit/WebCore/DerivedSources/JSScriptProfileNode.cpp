...
const ClassInfo JSScriptProfileNodePrototype::s_info = { "ScriptProfileNodePrototype", 0, &JSScriptProfileNodePrototypeTable, 0 };
...
const ClassInfo JSScriptProfileNode::s_info = { "ScriptProfileNode", 0, &JSScriptProfileNodeTable, 0 };
...
{
    return new (exec) JSScriptProfileNodePrototype(globalObject, JSScriptProfileNodePrototype::createStructure(globalObject->objectPrototype()));
}
...
JSValue jsScriptProfileNodeLineNumber(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    ScriptProfileNode* imp = static_cast<ScriptProfileNode*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->lineNumber());
    return result;
}
...
JSValue jsScriptProfileNodeTotalTime(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    ScriptProfileNode* imp = static_cast<ScriptProfileNode*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->totalTime());
    return result;
}
...
JSValue jsScriptProfileNodeSelfTime(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    ScriptProfileNode* imp = static_cast<ScriptProfileNode*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->selfTime());
    return result;
}
...
JSValue jsScriptProfileNodeNumberOfCalls(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    ScriptProfileNode* imp = static_cast<ScriptProfileNode*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->numberOfCalls());
    return result;
}
