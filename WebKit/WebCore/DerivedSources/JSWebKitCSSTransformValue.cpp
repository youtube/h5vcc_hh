...
{
    putDirect(exec->propertyNames().prototype, JSWebKitCSSTransformValuePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSWebKitCSSTransformValuePrototype(globalObject, JSWebKitCSSTransformValuePrototype::createStructure(JSCSSValueListPrototype::self(exec, globalObject)));
}
