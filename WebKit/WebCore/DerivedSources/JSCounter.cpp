...
{
    putDirect(exec->propertyNames().prototype, JSCounterPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSCounterPrototype(globalObject, JSCounterPrototype::createStructure(globalObject->objectPrototype()));
}
