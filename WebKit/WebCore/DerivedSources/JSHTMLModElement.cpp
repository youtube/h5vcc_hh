...
{
    putDirect(exec->propertyNames().prototype, JSHTMLModElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLModElementPrototype(globalObject, JSHTMLModElementPrototype::createStructure(JSHTMLElementPrototype::self(exec, globalObject)));
}
