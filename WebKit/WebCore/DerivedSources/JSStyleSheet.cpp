...
{
    putDirect(exec->propertyNames().prototype, JSStyleSheetPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSStyleSheetPrototype(globalObject, JSStyleSheetPrototype::createStructure(globalObject->objectPrototype()));
}
