...
{
    putDirect(exec->propertyNames().prototype, JSCharacterDataPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSCharacterDataPrototype(globalObject, JSCharacterDataPrototype::createStructure(JSNodePrototype::self(exec, globalObject)));
}
