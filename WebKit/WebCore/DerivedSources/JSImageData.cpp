...
{
    putDirect(exec->propertyNames().prototype, JSImageDataPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSImageDataPrototype(globalObject, JSImageDataPrototype::createStructure(globalObject->objectPrototype()));
}
