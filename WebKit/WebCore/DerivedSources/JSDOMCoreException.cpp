...
{
    putDirect(exec->propertyNames().prototype, JSDOMCoreExceptionPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
const ClassInfo JSDOMCoreExceptionPrototype::s_info = { "DOMExceptionPrototype", 0, 0, getJSDOMCoreExceptionPrototypeTable };
...
{
    return new (exec) JSDOMCoreExceptionPrototype(globalObject, JSDOMCoreExceptionPrototype::createStructure(globalObject->objectPrototype()));
}
