...
{
    putDirect(exec->propertyNames().prototype, JSMediaErrorPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSMediaErrorPrototype(globalObject, JSMediaErrorPrototype::createStructure(globalObject->objectPrototype()));
}
