...
{
    putDirect(exec->propertyNames().prototype, JSXPathEvaluatorPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSXPathEvaluatorPrototype(globalObject, JSXPathEvaluatorPrototype::createStructure(globalObject->objectPrototype()));
}
