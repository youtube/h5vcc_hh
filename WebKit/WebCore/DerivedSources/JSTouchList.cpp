...
{
    putDirect(exec->propertyNames().prototype, JSTouchListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSTouchListPrototype(globalObject, JSTouchListPrototype::createStructure(globalObject->objectPrototype()));
}
