...
static JSC_CONST_HASHTABLE HashTable JSFileTable = { 9, 7, JSFileTableValues, 0 };
...
{
    putDirect(exec->propertyNames().prototype, JSFilePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSFilePrototype(globalObject, JSFilePrototype::createStructure(JSBlobPrototype::self(exec, globalObject)));
}
