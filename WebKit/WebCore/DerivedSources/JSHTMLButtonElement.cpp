...
static const HashTableValue JSHTMLButtonElementTableValues[14] =
{
...
static JSC_CONST_HASHTABLE HashTable JSHTMLButtonElementTable = { 34, 31, JSHTMLButtonElementTableValues, 0 };
...
{
    putDirect(exec->propertyNames().prototype, JSHTMLButtonElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLButtonElementPrototype(globalObject, JSHTMLButtonElementPrototype::createStructure(JSHTMLElementPrototype::self(exec, globalObject)));
}
