...
{
    putDirect(exec->propertyNames().prototype, JSProcessingInstructionPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSProcessingInstructionPrototype(globalObject, JSProcessingInstructionPrototype::createStructure(JSNodePrototype::self(exec, globalObject)));
}
