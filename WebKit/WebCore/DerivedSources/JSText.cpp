...
{
    putDirect(exec->propertyNames().prototype, JSTextPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSTextPrototype(globalObject, JSTextPrototype::createStructure(JSCharacterDataPrototype::self(exec, globalObject)));
}
