...
{
    putDirect(exec->propertyNames().prototype, JSTextEventPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSTextEventPrototype(globalObject, JSTextEventPrototype::createStructure(JSUIEventPrototype::self(exec, globalObject)));
}
