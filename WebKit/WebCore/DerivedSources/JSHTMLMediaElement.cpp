...
static const HashTableValue JSHTMLMediaElementTableValues[28] =
{
    ...
    { "textTracks", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLMediaElementTextTracks), (intptr_t)0 THUNK_GENERATOR(0) },
#endif
...
#if ENABLE(VIDEO_TRACK) // FYMP - not auto-generated!
	{ "addTextTrack", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsHTMLMediaElementPrototypeFunctionAddTextTrack), (intptr_t)3 THUNK_GENERATOR(0) },
#endif
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};

#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSHTMLMediaElementPrototypeTable = { 36, 31, JSHTMLMediaElementPrototypeTableValues, 0 };
...
#if ENABLE(VIDEO_TRACK) // FYMP - not auto-generated!
JSValue jsHTMLMediaElementTextTracks(ExecState* exec, JSValue slotBase, const Identifier&)
{
	...
	TextTrackList*     pList = WTF::getPtr(imp->textTracks());
...
EncodedJSValue JSC_HOST_CALL jsHTMLMediaElementPrototypeFunctionAddTextTrack(ExecState* exec)
{
	...
	const String& kind     = ustringToString(exec->argument(0).toString(exec));
	const String& label    = ustringToString(exec->argument(1).toString(exec));
	const String& language = ustringToString(exec->argument(2).toString(exec));

	ExceptionCode ec = 0;
    PassRefPtr<TextTrack> track = imp->addTextTrack(kind, label, language, ec);
	setDOMException(exec, ec);
    return JSValue::encode(toJS(exec, WTF::getPtr(track)));
}
#endif
