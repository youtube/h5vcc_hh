...
{
    putDirect(exec->propertyNames().prototype, JSMouseEventPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSMouseEventPrototype(globalObject, JSMouseEventPrototype::createStructure(JSUIEventPrototype::self(exec, globalObject)));
}
...
EncodedJSValue JSC_HOST_CALL jsMouseEventPrototypeFunctionInitMouseEvent(ExecState* exec)
{
    ...
    unsigned short button = exec->argument(13).toInt32(exec);
