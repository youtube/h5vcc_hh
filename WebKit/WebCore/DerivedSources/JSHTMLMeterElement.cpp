...
const ClassInfo JSHTMLMeterElementConstructor::s_info = { "HTMLMeterElementConstructor", 0, &JSHTMLMeterElementConstructorTable, 0 };

JSHTMLMeterElementConstructor::JSHTMLMeterElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLMeterElementConstructor::createStructure(globalObject->objectPrototype()), globalObject)
{
    putDirect(exec->propertyNames().prototype, JSHTMLMeterElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
const ClassInfo JSHTMLMeterElementPrototype::s_info = { "HTMLMeterElementPrototype", 0, &JSHTMLMeterElementPrototypeTable, 0 };
...
{
    return new (exec) JSHTMLMeterElementPrototype(globalObject, JSHTMLMeterElementPrototype::createStructure(JSHTMLElementPrototype::self(exec, globalObject)));
}
...
JSValue jsHTMLMeterElementMin(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLMeterElement* imp = static_cast<HTMLMeterElement*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->min());
    return result;
}
...
JSValue jsHTMLMeterElementLow(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLMeterElement* imp = static_cast<HTMLMeterElement*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->low());
    return result;
}
...
JSValue jsHTMLMeterElementHigh(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLMeterElement* imp = static_cast<HTMLMeterElement*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->high());
    return result;
}
...
JSValue jsHTMLMeterElementOptimum(ExecState* exec, JSValue slotBase, const Identifier&)
{
    ...
    UNUSED_PARAM(exec);
    HTMLMeterElement* imp = static_cast<HTMLMeterElement*>(castedThis->impl());
    JSValue result = jsNumber(exec, imp->optimum());
    return result;
}
