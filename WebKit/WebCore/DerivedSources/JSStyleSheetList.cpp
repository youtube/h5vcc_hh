...
{
    putDirect(exec->propertyNames().prototype, JSStyleSheetListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSStyleSheetListPrototype(globalObject, JSStyleSheetListPrototype::createStructure(globalObject->objectPrototype()));
}
