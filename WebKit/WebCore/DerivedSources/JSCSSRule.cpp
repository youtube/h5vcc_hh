...
static const HashTableValue JSCSSRuleConstructorTableValues[11] =
{
    ...
    { "VARIABLES_RULE", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsCSSRuleVARIABLES_RULE), (intptr_t)0 THUNK_GENERATOR(0) },
...
{
    putDirect(exec->propertyNames().prototype, JSCSSRulePrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSCSSRulePrototype(globalObject, JSCSSRulePrototype::createStructure(globalObject->objectPrototype()));
}
