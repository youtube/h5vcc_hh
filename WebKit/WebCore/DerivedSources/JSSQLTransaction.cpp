...
const ClassInfo JSSQLTransactionPrototype::s_info = { "SQLTransactionPrototype", 0, 0, getJSSQLTransactionPrototypeTable };
...
{
    return new (exec) JSSQLTransactionPrototype(globalObject, JSSQLTransactionPrototype::createStructure(globalObject->objectPrototype()));
}
