...
{
    putDirect(exec->propertyNames().prototype, JSTouchEventPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSTouchEventPrototype(globalObject, JSTouchEventPrototype::createStructure(JSUIEventPrototype::self(exec, globalObject)));
}
