...
const ClassInfo JSSQLResultSetPrototype::s_info = { "SQLResultSetPrototype", 0, 0, getJSSQLResultSetPrototypeTable };
...
const ClassInfo JSSQLResultSet::s_info = { "SQLResultSet", 0, 0, getJSSQLResultSetTable };
...
{
    return new (exec) JSSQLResultSetPrototype(globalObject, JSSQLResultSetPrototype::createStructure(globalObject->objectPrototype()));
}
