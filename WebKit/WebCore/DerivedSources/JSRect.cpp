...
{
    putDirect(exec->propertyNames().prototype, JSRectPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSRectPrototype(globalObject, JSRectPrototype::createStructure(globalObject->objectPrototype()));
}
