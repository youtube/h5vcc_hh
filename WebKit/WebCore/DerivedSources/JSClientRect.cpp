...
{
    putDirect(exec->propertyNames().prototype, JSClientRectPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSClientRectPrototype(globalObject, JSClientRectPrototype::createStructure(globalObject->objectPrototype()));
}
