...
class JSCSSVariablesRulePrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSCSSVariablesRulePrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
