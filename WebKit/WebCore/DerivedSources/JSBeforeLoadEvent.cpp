...
{
    putDirect(exec->propertyNames().prototype, JSBeforeLoadEventPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSBeforeLoadEventPrototype(globalObject, JSBeforeLoadEventPrototype::createStructure(JSEventPrototype::self(exec, globalObject)));
}
