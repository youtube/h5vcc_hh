...
{
    putDirect(exec->propertyNames().prototype, JSHTMLDocumentPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    return new (exec) JSHTMLDocumentPrototype(globalObject, JSHTMLDocumentPrototype::createStructure(JSDocumentPrototype::self(exec, globalObject)));
}
