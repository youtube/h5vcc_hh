...
#define DOM_EVENT_NAMES_FOR_EACH(macro) \
    \
    macro(abort) \
	macro(addtrack) /* FYMP - integrating parts of r152754 */ \
    macro(beforecopy) \
    macro(beforecut) \
    macro(beforeload) \
    macro(beforepaste) \
    ...
    macro(contextmenu) \
    macro(copy) \
	macro(cuechange) /* FYMP - integrating parts of r152754 */ \
    macro(cut) \
    macro(dblclick) \
    ...
    macro(dragstart) \
    macro(drop) \
	macro(enter) /* FYMP - integrating parts of r152754 */ \
	macro(exit) /* FYMP - integrating parts of r152754 */ \
    macro(error) \
    macro(focus) \
    macro(focusin) \
    macro(focusout) \
    ...
    macro(playing) \
    macro(ratechange) \
	macro(removetrack) /* FYMP - integrating parts of r152754 */ \
    macro(seeked) \
    macro(seeking) \
    macro(timeupdate) \
    macro(volumechange) \
