...
// FactorY Modification Begin: renamed to be internal function & removed code section now in header
bool CSSStyleSelector::SelectorChecker::_checkOneSelector(CSSSelector* sel, Element* e, HashSet<AtomicStringImpl*>* selectorAttrs, PseudoId& dynamicPseudo, bool isSubSelector, RenderStyle* elementStyle, RenderStyle* elementParentStyle) const
{
#if 0
    if (!e)
        return false;
