...
double CSSPrimitiveValue::computeLengthDouble(RenderStyle* style, RenderStyle* rootStyle, double multiplier, bool computingFontSize)
{
    ...
    switch (type) {
        ...
        case CSS_PX:
            break;
/* FYWEBKITMOD BEGIN added cast to double */
        case CSS_CM:
            factor = (double)cssPixelsPerInch / 2.54; // (2.54 cm/in)
            break;
        case CSS_MM:
            factor = (double)cssPixelsPerInch / 25.4;
            break;
        case CSS_IN:
            factor = (double)cssPixelsPerInch;
            break;
        case CSS_PT:
            factor = (double)cssPixelsPerInch / 72.0;
            break;
        case CSS_PC:
            // 1 pc == 12 pt
            factor = (double)cssPixelsPerInch * 12.0 / 72.0;
            break;
/* FYWEBKITMOD END */
        default:
            return -1.0;
...
/* FYWEBKITMOD BEGIN added cast to double */
        ...
        case CSSPrimitiveValue::CSS_PC:
            factor = (double)cssPixelsPerInch * 12.0 / 72.0; // 1 pc == 12 pt
            break;
/* FYWEBKITMOD END */
        default:
            break;
