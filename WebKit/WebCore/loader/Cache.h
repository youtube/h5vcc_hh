...
#include "CachedResourceHandle.h" // FYWEBKITMOD - integrated feature 'SubCache'. See comment to class SubCache for more details.
...
class SubCache;                  // FYWEBKITMOD - integrated feature 'SubCache'. See comment to class SubCache for more details.
...
/* FYWEBKITMOD END */
    ...
    void addSubCache(SubCache*);    // FYWEBKITMOD - integrated feature 'SubCache'. See comment to class SubCache for more details.
    void removeSubCache(SubCache*); // FYWEBKITMOD - integrated feature 'SubCache'. See comment to class SubCache for more details.
...
private:
    ...
    HashSet<SubCache*> m_subCaches; // FYWEBKITMOD - integrated feature 'SubCache'. See comment to class SubCache for more details.
    Loader m_loader;
...
// FYWEBKITMOD BEGIN - integrated feature 'SubCache'.

// This bugfix was integrated from https://bugs.webkit.org/show_bug.cgi?format=multiple&id=49008
