...
namespace WebCore {
    ...
    public:
		...
		virtual void didReceiveSomeData(CachedResource*) {} // FYWEBKITMOD Needed to report partial loaded data to the client. The parser of TextTracks uses this. (while integrating parts of r152754.)
    };
