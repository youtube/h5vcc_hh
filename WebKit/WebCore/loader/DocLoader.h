...
#include "Cache.h" // FYWEBKITMOD integrated feature 'SubCache'. See comment to class SubCache for more details.
#include "CachedResource.h"
#include "CachedResourceHandle.h"
#include "CachedTextTrack.h" // FYWEBKITMOD adding support for TextTracks to DocLoader instead of CachedResourceLoader as in latest WebKit (while integrating parts of r152754)
...
class ImageLoader;
class KURL;
class Request; // FYWEBKITMOD added 2011/04/20
...
#endif
// FYWEBKITMOD BEGIN adding support for TextTracks to DocLoader instead of CachedResourceLoader as in latest WebKit (while integrating parts of r152754)
#if ENABLE(VIDEO_TRACK)
CachedTextTrack* requestTextTrack(const String& url);
#endif
// FYWEBKITMOD END
...
// FYWEBKITMOD BEGIN - modified due to feature 'SubCache'. See comment to class SubCache for more details.
...
// FYWEBKITMOD END
    ...
    void cancelRequest(Request*); // FYWEBKITMOD added 2011/04/20
