...
/* FYWEBKITMOD BEGIN initially copied over from rendering/RenderThemeChromiumSkia.h */

#ifndef RenderThemeFymp_h
#define RenderThemeFymp_h
...
class RenderProgress;
    ...
    class RenderThemeFymp : public RenderTheme {
    public:
        RenderThemeFymp();
        virtual ~RenderThemeFymp();

        static PassRefPtr<RenderTheme> create(); // FYWEBKITMOD
