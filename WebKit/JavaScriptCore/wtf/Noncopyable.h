...
namespace WTFNoncopyable {
    ...
    class FYMP_PRXSYM_WEBKIT Noncopyable : public FastAllocBase { // FYWEBKITMOD exported symbol
    ...
    class FYMP_PRXSYM_WEBKIT NoncopyableCustomAllocated { // FYWEBKITMOD exported symbol
