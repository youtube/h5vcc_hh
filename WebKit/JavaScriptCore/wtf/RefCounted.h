...
class FYMP_PRXSYM_WEBKIT RefCountedBase { // FYWEBKITMOD exported symbol
public:
    void ref()
    {
...
template<typename T> class FYMP_PRXSYM_WEBKIT RefCounted : public RefCountedBase, public Noncopyable { // FYWEBKITMOD exported symbol
public:
    void deref()
    {
        if (derefBase())
