...
#if (defined(WIN32) || defined(_WIN32) || defined(WIN64) || defined(_WIN64)) && !defined(_XBOX) // FYWEBKITMOD: added XBox exclusion
...
#           define U_WCHAR_IS_UTF32
#       endif
#   elif (defined(WIN32) || defined(_WIN32) || defined(WIN64) || defined(_WIN64)) && !defined(_XBOX)	//FYMP: added XBox exclusion
#       define U_WCHAR_IS_UTF16    
#   endif
#endif
