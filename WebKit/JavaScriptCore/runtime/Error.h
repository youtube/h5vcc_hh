...
namespace JSC {
    ...
    // ExecState wrappers.
    FYMP_PRXSYM_WEBKIT JSObject* createError(ExecState*, const UString&); // FYWEBKITMOD exported symbol
    ...
    FYMP_PRXSYM_WEBKIT JSValue throwError(ExecState*, JSValue); // FYWEBKITMOD exported symbol
    FYMP_PRXSYM_WEBKIT JSObject* throwError(ExecState*, JSObject*); // FYWEBKITMOD exported symbol
