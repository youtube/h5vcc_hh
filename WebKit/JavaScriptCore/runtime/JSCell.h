...
namespace JSC {
    ...
    class FYMP_PRXSYM_WEBKIT JSCell : public NoncopyableCustomAllocated { // FYWEBKITMOD exported symbol
...
/* FYWEBKITMOD BEGIN */
        ...
        void* vptr() { unsigned char *address = (unsigned char *) this;
     				   return *reinterpret_cast<void**>(address + sizeof(*this) - sizeof(void*)); }
        void setVPtr(void* vptr) {	unsigned char *address = (unsigned char *) this;
        							*reinterpret_cast<void**>(address + (sizeof(*this) - sizeof(void*))) = vptr;}
/* FYWEBKITMOD END */
#else
    ...
    inline bool JSValue::toBoolean(ExecState* exec) const
    {
        ...
        {
/* FYWEBKITMOD BEGIN */
		#ifdef FYMP_EXPLICIT_NAN_TESTS
            double d = asDouble();
            return !isnan(d) && (d > 0.0 || d < 0.0);
/* FYWEBKITMOD END */
        #else
