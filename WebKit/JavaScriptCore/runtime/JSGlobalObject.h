...
namespace JSC {
    ...
    class FYMP_PRXSYM_WEBKIT JSGlobalObject : public JSVariableObject { // FYWEBKITMOD exported symbol
/* FYWEBKITMOD BEGIN changed access modifier from 'protected' to 'public' */
    public:
/* FYWEBKITMOD END */
